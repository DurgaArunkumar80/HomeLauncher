...
import com.app.homelauncher.fragment.SettingsBaseFragment;
import com.app.homelauncher.fragment.SettingsMasterFragment;
import com.app.homelauncher.manager.Setup;
import com.app.homelauncher.util.BackupHelper;
        ...
        if (resultCode == RESULT_OK) {
            ...
            switch (requestCode) {
                case Definitions.INTENT_BACKUP:
                    BackupHelper.backupConfig(this, new File(Utils.getFileForUri(files.get(0)).getAbsolutePath() + "/HomeLauncher.zip").toString());
